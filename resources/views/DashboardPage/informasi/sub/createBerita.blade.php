                ...
                <form action="{{ route('simpanberita') }}" method="post" enctype="multipart/form-data" class="berita-preview-form">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-10">
                            <div>
                                <h3 class="mb-1">Tulis Berita</h3>
                                <span class="text-muted">Gunakan preview untuk melihat tampilan berita seperti di landing page.</span>
                            </div>
                        ...
                        <div class="berita-editor-panel">
                            <div class="mb-10">
                                ...
                                <input type="text" id="judulBerita" class="form-control form-control-solid berita-judul-input" placeholder="Judul"
                                    name="judul" required />
                                <input type="text" name="id" hidden>
                            </div>
                            <div class="mb-10">
                                <label for="kategoriBerita" class="required form-label">Kategori</label>
                                <select id="kategoriBerita" class="form-select form-select-solid berita-kategori-input" name="kategori" aria-label="Select example">
                                        ...
                                        <div class="row justify-content-center mx-0">
                                            <div class="col-lg-10 posts-list">
                                                <div class="single-post bg-white rounded-4 shadow-sm p-6">
                                                    <h2 class="berita-preview-judul mb-4">Judul berita akan tampil di sini</h2>
                                                    <div class="feature-img berita-preview-image-wrap d-none">
                                                        <img class="img-fluid w-100 rounded-3 berita-preview-image" src="" alt="Preview gambar berita">
                                                    </div>
                                                    <div class="blog_details mt-4">
                                                        ...
                                                        <p class="text-muted mb-4 berita-preview-kategori">Kategori terpilih akan tampil di sini</p>
                                                        <div class="excert berita-preview-konten">
                                                            Konten berita akan tampil di sini.
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
