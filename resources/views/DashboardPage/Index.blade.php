                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data"
                                        ...
                                        <div class="modal-body">
                                            <div class="fv-row mb-10">
                                                <!--begin::Input-->
                                                <label class="text-dark fw-bolder text-hover-primary fs-6">Nama Lengkap
                                                    Mantan Direktur</label>
                                                <input type="text" name="dokumen"
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <label class="text-dark fw-bolder text-hover-primary fs-6">Awal
                                                    Menjabat</label>
                                                <input type="text" name="link" id="Awal_Menjabat"
                                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                                                    required />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-10">
                                                ...
                                                <label class="text-dark fw-bolder text-hover-primary fs-6">Akhir
                                                    Menjabat</label>
                                                <input type="text" name="link" id="Akhir_Menjabat"
                                                    class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
                                                    required />
                                                <!--end::Input-->
                                            </div>
