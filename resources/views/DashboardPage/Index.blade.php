                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end flex-shrink-0">
                                                        ...
                                                        <form action="{{ route('hapus', $p->id) }}" method="post"> @csrf
                                                            @method('delete')
                                                            <button
                                                                onclick="return confirm ('Yakin Ingin Menghapus Data ini ?')"
                                                                class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm border border-danger" data-bs-toggle="tooltip" data-bs-placement="Top" title="Hapus">
