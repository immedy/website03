...
var KTDrawer = function(e, t) {
    ...
    if (null != e) {
        var r = {
          ...
          , l = function() {
            !1 !== KTEventHandler.trigger(n.element, "kt.drawer.toggle", n) && (!0 === n.shown ? s() : u(),
            ...
            return function(t, n, i, r) {
                if (!0 === KTUtil.data(t).has(n)) {
                    ...
                    if (e[n] && e[n][o]) {
                        ...
                        if (a.name === n) {
                            if (1 != a.one)
                                return a.callback.call(this, i, r);
                            if (0 == a.fired)
                                return e[n][o].fired = !0,
...
var KTImageInput = function(e, t) {
    ...
    if (null != e) {
        var i = {}
          ...
          , l = function(e) {
            e.preventDefault(),
            !1 !== KTEventHandler.trigger(n.element, "kt.imageinput.cancel", n) && (KTUtil.removeClass(n.element, "image-input-changed"),
            KTUtil.removeClass(n.element, "image-input-empty"),
          ...
          , s = function(e) {
            e.preventDefault(),
            !1 !== KTEventHandler.trigger(n.element, "kt.imageinput.remove", n) && (KTUtil.removeClass(n.element, "image-input-changed"),
...
var KTMenu = function(e, t) {
    ...
    if (null != e) {
        var i = {
          ...
          , a = function(e) {
            e || (e = n.triggerElement),
            !0 !== m(e) && ("dropdown" === v(e) ? E(e) : "accordion" === v(e) && S(e),
            KTUtil.data(e).set("type", v(e)))
        }
          , l = function(e) {
            e || (e = n.triggerElement),
            !1 !== m(e) && ("dropdown" === v(e) ? w(e) : "accordion" === v(e) && A(e))
        }
          , s = function(e) {
            if (!1 !== f(e)) {
                var t = g(e);
          ...
          , E = function(e) {
            if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                ...
                !0 === x(e, "overflow") ? (document.body.appendChild(t),
          ...
          , w = function(e) {
            if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.hide", e)) {
                ...
                KTUtil.removeClass(t, "show"),
                !0 === x(e, "overflow") && (e.classList.contains("menu-item") ? e.appendChild(t) : KTUtil.insertAfter(n.element, e),
          ...
          , I = function(e) {
            ...
            if (i && i.length > 0)
                for (var r = 0, o = i.length; r < o; r++)
                    t = i[r],
                    "accordion" === v(t) && t !== e && !1 === e.contains(t) && !1 === t.contains(e) && A(t)
        }
          , x = function(e, t) {
            var n, i = null;
        ...
        ,
        n.link = function(e, t) {
            !1 !== KTEventHandler.trigger(n.element, "kt.menu.link.click", n) && (KTMenu.hideDropdowns(),
        ...
        n.mouseover = function(e, t) {
            return function(e, t) {
                var n = T(e);
                null !== n && "hover" === x(n, "trigger") && ("1" === KTUtil.data(n).get("hover") && (clearTimeout(KTUtil.data(n).get("timeout")),
...
var KTScroll = function(e, t) {
    ...
    if (e) {
        var i = {
          ...
          , a = function() {
            var e, t;
            !0 === u("activate") || !1 === n.element.hasAttribute("data-kt-scroll-activate") ? (e = d(),
          ...
          , s = function() {
            ...
            if (null !== i && ((e = document.querySelectorAll(i)) && e.length > 0))
                for (var a = 0, l = e.length; a < l; a++) {
                    var s = e[a];
                    !1 !== KTUtil.visible(s) && (t -= parseInt(KTUtil.css(s, "height")),
            ...
            if (null !== r && ((e = document.querySelectorAll(r)) && e.length > 0))
                ...
                l = e.length; a < l; a++) {
                    s = e[a];
                    !1 !== KTUtil.visible(s) && (t -= parseInt(KTUtil.css(s, "margin-top")),
                    t -= parseInt(KTUtil.css(s, "margin-bottom")),
    ...
    if (null != e) {
        var r = {
          ...
          , a = function(e) {
            ...
            !0 === o ? (t > r ? (!1 === i.hasAttribute(n.attributeName) && (l(),
            ...
            n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(),
            i.removeAttribute(n.attributeName)),
            !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n),
            KTEventHandler.trigger(n.element, "kt.sticky.change", n),
            n.eventTriggerState = !0)),
            n.lastScrollTop = t) : t > r ? (!1 === i.hasAttribute(n.attributeName) && (l(),
            i.setAttribute(n.attributeName, "on")),
            !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n),
            KTEventHandler.trigger(n.element, "kt.sticky.change", n),
            n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(),
          ...
          , l = function(e) {
            ...
            null !== o && (KTUtil.css(n.element, "z-index", o),
        ...
        n.update = function() {
            !0 === i.hasAttribute(n.attributeName) && (s(),
            i.removeAttribute(n.attributeName),
            l(!0),
            i.setAttribute(n.attributeName, "on"))
        }
    ...
    return {
        ...
        getResponsiveValue: function(e, t) {
            ...
            if ("object" == typeof (e = KTUtil.parseJson(e))) {
                var r, o, a = -1;
                for (var l in e)
                    (o = "default" === l ? 0 : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <= i && o > a && (r = l,
                    a = o);
                n = r ? e[r] : e
            } else
                n = e;
...
var KTApp = function() {
    var e = function(e, t) {
      ...
      , t = function(e, t) {
        ...
        !0 === t.dismiss && (t.template = '<div class="popover" role="tooltip"><div class="popover-arrow"></div><span class="popover-dismiss btn btn-icon"><i class="bi bi-x fs-2"></i></span><h3 class="popover-header"></h3><div class="popover-body"></div></div>');
